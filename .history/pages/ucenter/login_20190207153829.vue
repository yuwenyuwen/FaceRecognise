<template>
	<view class="s-page-wrapper is-100vh">
		<view class="is-33vh has-mgt-10">
			...
			<text class="programName">FaceRecognise</text>
		</view>
		<view class="content">
			<view class="has-mglr-10 ">
				...
				<view class=" has-radius has-mgtb-10">
					<input v-model="login.password" placeholder="请输入登录密码" class="is-input1"  data-val="password"/>
				</view>
		...
		<view class="is-20vh has-mgt-80 content" >
			<navigator url="register" class=" has-radius is-right is-grey has-mgr-20" hover-class="">
